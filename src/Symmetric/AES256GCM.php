...
/**
 * Implementação de criptografia simétrica usando AES-256-GCM
 */
final class AES256GCM implements SymmetricCryptoInterface
{
    ...
    /**
     * Verifica se o algoritmo AES-256-GCM está disponível
     *
